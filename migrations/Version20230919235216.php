 ...
 */
final class Version20230919235216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expense_report (id INT AUTO_INCREMENT NOT NULL, report_type_id INT NOT NULL, company_id INT NOT NULL, owner_id INT NOT NULL, report_date DATETIME NOT NULL, amount DOUBLE PRECISION NOT NULL, INDEX IDX_280A691A5D5F193 (report_type_id), INDEX IDX_280A691979B1AD6 (company_id), INDEX IDX_280A6917E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
